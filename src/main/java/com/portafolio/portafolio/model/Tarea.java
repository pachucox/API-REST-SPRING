...
public class Tarea {
	...
	public Tarea(int id_tarea, String descripcion_tarea, int id_responsable, int id_creador,
			String fecha_inicio, String fecha_termino, String fecha_limite, int id_tareapadre, int tarea_id_tarea,
			int funcion_id_funcion) {
